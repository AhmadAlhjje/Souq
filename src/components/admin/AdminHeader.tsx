...
const AdminHeader: React.FC<AdminHeaderProps> = ({ onToggleSidebar, title }) => {
  ...
  const formatNotificationTime = (date: Date) => {
    ...
    if (minutes < 1440)
      return isRTL ? `${Math.floor(minutes / 60)} ${t("hours")}` : `${Math.floor(minutes / 60)} ${t("hours")}`;
  ...
  return (
    <header
      className={`
        ...
        ${isDark ? "bg-gray-900 border-gray-700" : "bg-white border-[#96EDD9]"}
      `}
      dir={isRTL ? "rtl" : "ltr"}
    >
        ...
        <div className={`flex items-center gap-4 ${isRTL ? "order-1" : "order-0"}`}>
          <button
            ...
            className={`
              ...
              ${isDark ? "hover:bg-gray-700 text-gray-300" : "hover:bg-[#CFF7EE] text-[#004D5A]"}
            `}
          >
            <Menu size={20} />
          </button>
          ...
          <div>
            <h1 className={`text-lg font-semibold ${isDark ? "text-white" : "text-[#004D5A]"}`}>
              {displayTitle}
            </h1>
          </div>
        </div>
        ...
        <div className={`flex items-center gap-2 ${isRTL ? "order-0" : "order-1"}`}>
          <button
            ...
            className={`
              ...
              ${isDark ? "hover:bg-gray-700 text-gray-300" : "hover:bg-[#96EDD9] text-[#004D5A]"}
            `}
          ...
          <div className="relative" ref={notificationRef}>
            ...
            >
              ...
              {unreadCount > 0 && (
                <span
                  className={`absolute -top-1 ${isRTL ? "-right-1" : "-left-1"} bg-[#5CA9B5] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center`}
                >
                  {unreadCount}
                </span>
              )}
              ...
              {showNotifications && (
                <motion.div
                  ...
                  className={`
                    ...
                    ${isDark ? "bg-gray-800 border-gray-600" : "bg-white border-[#96EDD9]"}
                  `}
                >
                  <div className="p-4">
                    <h3
                      className={`font-semibold mb-3 ${isDark ? "text-white" : "text-[#004D5A]"}`}
                    >
                            ...
                            ${
                              notification.isRead
                                ? isDark
                                  ...
                                  : "bg-[#CFF7EE] border-[#96EDD9]"
                                : isDark
                                ? "bg-gray-600 border-gray-500"
                                : "bg-[#BAF3E6] border-[#95EDD8]"
                            }
                          `}
                        >
                          <div className={`flex items-start gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
                            ...
                            <div className="flex-1 min-w-0">
                              <p className={`font-medium text-sm ${isDark ? "text-white" : "text-[#004D5A]"}`}>
                                {notification.title}
                              </p>
                              <p className={`text-xs mt-1 ${isDark ? "text-gray-300" : "text-[#666666]"}`}>
                                {notification.message}
                              </p>
                              <p className={`text-xs mt-1 ${isDark ? "text-gray-400" : "text-[#5CA9B5]"}`}>
                    ...
                    <div className="mt-3 pt-3 border-t border-[#96EDD9] dark:border-gray-600">
                      <button
                        className={`
                          ...
                          ${isDark ? "text-blue-400 hover:bg-gray-700" : "text-[#004D5A] hover:bg-[#CFF7EE]"}
                        `}
                      >
              ...
              {showUserMenu && (
                ...
                >
                  <div className="p-4 border-b border-[#96EDD9] dark:border-gray-600">
                    <p className={`font-medium ${isDark ? "text-white" : "text-[#004D5A]"}`}>
                      {t("admin_name")}
                    </p>
                  ...
                  <div className="border-t border-[#96EDD9] dark:border-gray-600 py-2">
                    <button
                      className={`
                        flex items-center gap-3 w-full px-4 py-2 text-sm transition-colors
                        ${isRTL ? "text-right flex-row-reverse" : "text-left"}
                        ${isDark ? "text-red-400 hover:bg-gray-700" : "text-[#5CA9B5] hover:bg-[#CFF7EE]"}
                      `}
                    >
                      <LogOut size={16} />
                      {t("logout")}
