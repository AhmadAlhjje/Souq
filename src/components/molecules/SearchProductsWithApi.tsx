// SearchProductsWithApi.tsx - مكون البحث في المنتجات
  ...
  return (
    <div className={`relative ${className}`}>
      <input
        ...
        className="w-full px-4 py-3 pl-12 pr-12 text-right border-2 border-teal-300 rounded-xl focus:border-teal-500 focus:outline-none transition-colors bg-white"
      />
