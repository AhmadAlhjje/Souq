...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative mt-16 min-h-screen bg-gradient-to-br from-[#96EDD9] via-[#A8F0DC] to-[#B8F3E0] overflow-hidden">
      ...
      <div
        className={`flex items-center ${justifyContent} min-h-screen px-6 sm:px-12 md:px-16 lg:px-20`}
      >
        <div className={`max-w-2xl ${textAlign} space-y-8 relative z-10`}>
          ...
          <div className="space-y-4">
            ...
            {/* Decorative Line */}
            <div
              className={`w-20 h-1 bg-gradient-${gradientDirection} from-[#004D5A] to-transparent ${marginAuto} rounded-full`}
            ></div>
          </div>
