...
// ========================================
// 3. src/app/shipping/page.tsx - الصفحة الرئيسية مع Session
// ========================================
...
const ShippingPage: React.FC = () => {
  ...
  // عرض شاشة التحميل أثناء تهيئة الـ session
  if (isLoading) {
    return (
      <div
      ...
      >
        <div className="text-center">
          ...
          <p className="text-lg" style={{ color: COLORS[theme].text.primary }}>
            جاري تهيئة الجلسة...
          </p>
        </div>
      </div>
