  ...
  return (
    ...
    >
      ...
      <div className="text-white text-base text-right">
        {" "}
        {/* تصغير من text-xl إلى text-base */}
        {icon}
      </div>
    </div>
  );
  ...
  const solutions = [
    {
      ...
      description:
        "لا تحتاج لخبرة سابقة أو تفرغ تام لتبدأ تجارتك معنا. واجهة بديهية وأدوات ذكية تجعل البداية أسهل مما تتوقع",
      image: "/images/image 1.png",
      buttonIcon: (
        <FaStore className="text-sm" />
      ) /* تصغير من text-lg إلى text-sm */,
    ...
    },
    {
      ...
      description:
        "استفد من نظام TMC المتكامل للمدفوعات الإلكترونية لإدارة مدفوعات متجرك وعملائك بأمان وسهولة تامة",
    ...
    },
    {
      ...
      description:
        "خيارات شحن متنوعة تربط متجرك بالعالم، مع ضمان وصول منتجاتك بأمان وفي الوقت المحدد",
    ...
    },
    {
      ...
      description:
        "استهدف المزيد من العملاء بحلول تسويقية مخصصة ومتقدمة تضمن وصول منتجاتك للجمهور المناسب",
  ...
  return (
    <div className="relative">
      ...
      <div className="text-center mb-16">
        <Badge text="🛠️ حلول متكاملة" variant="primary" className="mb-6" />
        <Heading
      ...
      <div className=" text-right space-y-16">
        {" "}
        {/* تقليل المسافة من space-y-20 إلى space-y-16 */}
          ...
          <div key={solution.id} className="relative">
            ...
            >
              <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 p-6 lg:p-10 items-center">
                ...
                >
                  {" "}
                  {/* تقليل من space-y-8 إلى space-y-6 */}
                  {/* Header */}
                  <div>
                    <Heading
                      text={solution.title}
                  ...
                  <div className="space-y-4">
                    {" "}
                    {/* تقليل من space-y-6 إلى space-y-4 */}
