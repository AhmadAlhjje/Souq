// // ===========================================
// // 1. HeroSection.tsx - خلفية داكنة موحدة
// // ===========================================
// 'use client';
...
//   return (
//     <div className={`mt-20 relative min-h-screen overflow-hidden transition-colors duration-500 ${
//       isDark 
//         ? 'bg-slate-900' 
...
//         <div className={`absolute top-32 right-1/3 w-40 h-40 rounded-full blur-2xl transition-colors duration-500 ${
//           isDark 
//             ? 'bg-emerald-500/20' 
//             : 'bg-gradient-to-br from-teal-500/30 to-transparent'
//         }`}></div>
//         <div className={`absolute bottom-32 left-1/4 w-60 h-60 rounded-full blur-3xl transition-colors duration-500 ${
//           isDark 
//             ? 'bg-emerald-600/15' 
...
//                   <div className={`w-3 h-3 rounded-full animate-pulse transition-colors duration-300 ${
...
//                 <Typography className={`text-xl sm:text-2xl lg:text-3xl font-bold leading-relaxed transition-colors duration-300 ${
...
//                   <span className={`block text-lg sm:text-xl lg:text-2xl font-medium mt-2 transition-colors duration-300 ${
...
//               {/* Stats Section */}
//               <div className={`pt-2 animate-in slide-in-from-right duration-1000 delay-700 border-t transition-colors duration-300 ${
