...
const ProductDetails: React.FC<ProductDetailsProps> = ({
  ...
  return (
    <div className={`space-y-3 ${className}`} dir="rtl" role="region" aria-label="تفاصيل المنتج">
      ...
      <div className="py-2">
        <div className="flex items-center gap-3 flex-wrap">
          <label className="text-sm font-medium whitespace-nowrap" htmlFor="quantity-control">
            الكمية:
          </label>
          <QuantityControl
            quantity={quantity}
      ...
      {isOutOfStock && (
        ...
        >
          <AlertTriangle className="w-4 h-4 flex-shrink-0" />
          هذا المنتج غير متوفر حاليًا. يمكنك إضافته إلى قائمة الرغبات أو مراجعته لاحقًا.
        </div>
      )}
